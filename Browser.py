...
""")
    ...
    # write_msg(f"已加载的扩展: {driver.execute_script('return navigator.plugins')}")
    ...
    if not auto:
        ...
        # input()  # debugging...
        time.sleep(5)
        #user_element = driver.find_elements(By.ID, "username")[match] # for openmsr
        ...
        #pwd = driver.find_elements(By.ID, "password")[match] # for openmsr
        ...
        return {
            "cookie_str": cookie_str[:-2],  # -2 for last '; '
