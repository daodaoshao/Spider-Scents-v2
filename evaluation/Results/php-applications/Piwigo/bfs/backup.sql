...
(1,'system',3,'activate',0,'none','192.168.224.1','2023-03-08 19:47:02','a:3:{s:8:\"theme_id\";s:5:\"modus\";s:7:\"version\";s:6:\"13.6.0\";s:6:\"script\";s:7:\"install\";}',NULL),
(2,'system',3,'activate',0,'none','192.168.224.1','2023-03-08 19:47:02','a:3:{s:8:\"theme_id\";s:11:\"smartpocket\";s:7:\"version\";s:6:\"13.6.0\";s:6:\"script\";s:7:\"install\";}',NULL),
(3,'system',1,'install',0,'none','192.168.224.1','2023-03-08 19:47:03','a:2:{s:7:\"version\";s:6:\"13.6.0\";s:6:\"script\";s:7:\"install\";}',NULL),
(4,'user',1,'login',1,'7143949d105e025cdfbb5c0ca02c97d0','192.168.224.1','2023-03-08 19:47:03','a:1:{s:6:\"script\";s:7:\"install\";}','Mozilla/5.0 (Macintosh; Intel Mac OS X 10.15; rv:109.0) Gecko/20100101 Firefox/110.0');
...
CREATE TABLE `piwigo_categories` (
  ...
  KEY `site_id` (`site_id`),
  KEY `representative_picture_id` (`representative_picture_id`),
  CONSTRAINT `piwigo_categories_ibfk_1` FOREIGN KEY (`id_uppercat`) REFERENCES `piwigo_categories` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `piwigo_categories_ibfk_2` FOREIGN KEY (`site_id`) REFERENCES `piwigo_sites` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `piwigo_categories_ibfk_3` FOREIGN KEY (`representative_picture_id`) REFERENCES `piwigo_images` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `piwigo_comments` (
  ...
  CONSTRAINT `piwigo_comments_ibfk_1` FOREIGN KEY (`image_id`) REFERENCES `piwigo_images` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `piwigo_comments_ibfk_2` FOREIGN KEY (`author_id`) REFERENCES `piwigo_users` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
('update_notify_last_check','2023-03-08T19:47:38+00:00',NULL),
('fs_quick_check_last_check','2023-03-08T19:47:41+00:00',NULL);
...
CREATE TABLE `piwigo_favorites` (
  ...
  CONSTRAINT `piwigo_favorites_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `piwigo_users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `piwigo_favorites_ibfk_2` FOREIGN KEY (`image_id`) REFERENCES `piwigo_images` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `piwigo_group_access` (
  ...
  KEY `cat_id` (`cat_id`),
  CONSTRAINT `piwigo_group_access_ibfk_1` FOREIGN KEY (`group_id`) REFERENCES `piwigo_groups` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `piwigo_group_access_ibfk_2` FOREIGN KEY (`cat_id`) REFERENCES `piwigo_categories` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `piwigo_image_category` (
  ...
  CONSTRAINT `piwigo_image_category_ibfk_1` FOREIGN KEY (`image_id`) REFERENCES `piwigo_images` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `piwigo_image_category_ibfk_2` FOREIGN KEY (`category_id`) REFERENCES `piwigo_categories` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `piwigo_image_format` (
  ...
  KEY `image_id` (`image_id`),
  CONSTRAINT `piwigo_image_format_ibfk_1` FOREIGN KEY (`image_id`) REFERENCES `piwigo_images` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `piwigo_image_tag` (
  ...
  CONSTRAINT `piwigo_image_tag_ibfk_1` FOREIGN KEY (`image_id`) REFERENCES `piwigo_images` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `piwigo_image_tag_ibfk_2` FOREIGN KEY (`tag_id`) REFERENCES `piwigo_tags` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `piwigo_lounge` (
  ...
  CONSTRAINT `piwigo_lounge_ibfk_1` FOREIGN KEY (`image_id`) REFERENCES `piwigo_images` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `piwigo_lounge_ibfk_2` FOREIGN KEY (`category_id`) REFERENCES `piwigo_categories` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `piwigo_old_permalinks` (
  ...
  KEY `cat_id` (`cat_id`),
  CONSTRAINT `piwigo_old_permalinks_ibfk_1` FOREIGN KEY (`cat_id`) REFERENCES `piwigo_categories` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `piwigo_rate` (
  ...
  KEY `user_id` (`user_id`),
  CONSTRAINT `piwigo_rate_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `piwigo_users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `piwigo_rate_ibfk_2` FOREIGN KEY (`element_id`) REFERENCES `piwigo_images` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
('C0A87143949d105e025cdfbb5c0ca02c97d0','pwg_uid|i:1;pwg_device|s:7:\"desktop\";pwg_mobile_theme|b:0;cache_activity_last_weeks|a:2:{s:13:\"calculated_on\";i:1678304861;s:4:\"data\";a:1:{i:3;a:1:{i:3;a:3:{s:7:\"details\";a:2:{s:6:\"System\";a:2:{s:8:\"Activate\";s:1:\"2\";s:7:\"Install\";s:1:\"1\";}s:4:\"User\";a:1:{s:5:\"Login\";s:1:\"1\";}}s:6:\"number\";i:4;s:4:\"date\";s:22:\"Wednesday 8 March 2023\";}}}}pwg_caps|a:3:{i:0;s:1:\"2\";i:1;s:4:\"1512\";i:2;s:3:\"801\";}need_update13.6.0|b:0;extensions_need_update|a:0:{}','2023-03-08 19:47:43');
...
CREATE TABLE `piwigo_user_access` (
  ...
  KEY `cat_id` (`cat_id`),
  CONSTRAINT `piwigo_user_access_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `piwigo_users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `piwigo_user_access_ibfk_2` FOREIGN KEY (`cat_id`) REFERENCES `piwigo_categories` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `piwigo_user_auth_keys` (
  ...
  KEY `user_id` (`user_id`),
  CONSTRAINT `piwigo_user_auth_keys_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `piwigo_users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `piwigo_user_cache` (
  ...
  PRIMARY KEY (`user_id`),
  CONSTRAINT `piwigo_user_cache_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `piwigo_users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
(1,'false',1678304823,'0',0,NULL,0,NULL,'NOT IN','0');
...
CREATE TABLE `piwigo_user_cache_categories` (
  ...
  PRIMARY KEY (`user_id`,`cat_id`),
  KEY `cat_id` (`cat_id`),
  KEY `user_representative_picture_id` (`user_representative_picture_id`),
  CONSTRAINT `piwigo_user_cache_categories_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `piwigo_users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `piwigo_user_cache_categories_ibfk_2` FOREIGN KEY (`cat_id`) REFERENCES `piwigo_categories` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `piwigo_user_cache_categories_ibfk_3` FOREIGN KEY (`user_representative_picture_id`) REFERENCES `piwigo_images` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `piwigo_user_feed` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `piwigo_user_feed_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `piwigo_users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `piwigo_user_group` (
  ...
  KEY `user_id` (`user_id`),
  CONSTRAINT `piwigo_user_group_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `piwigo_users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `piwigo_user_group_ibfk_2` FOREIGN KEY (`group_id`) REFERENCES `piwigo_groups` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `piwigo_user_infos` (
  ...
  PRIMARY KEY (`user_id`),
  KEY `lastmodified` (`lastmodified`),
  CONSTRAINT `piwigo_user_infos_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `piwigo_users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
(1,15,'webmaster','en_GB','false','false','false',7,'modus','2023-03-08 19:47:02','true',8,NULL,NULL,'2023-03-08 19:47:38','false','2023-03-08 19:47:02',NULL),
(2,15,'guest','en_GB','false','false','false',7,'modus','2023-03-08 19:47:02','true',0,NULL,NULL,NULL,'false','2023-03-08 19:47:02',NULL);
...
CREATE TABLE `piwigo_user_mail_notification` (
  ...
  CONSTRAINT `piwigo_user_mail_notification_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `piwigo_users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
(1,'admin','5f4dcc3b5aa765d61d8327deb882cf99','admin@email.com'),
(2,'guest',NULL,NULL);
...
-- Dump completed on 2025-03-23 19:51:50
